 ...
 * @param key
 */
const castNumKey = (key) => (isNaN_1.default(key) ? key : Number(key));
/**
 * @param {string} string
 */
...
function getFieldPath(fieldname) {
    if (!fieldname) {
        throw http_errors_1.default(400, "Field name cannot be empty.");
    }
    ...
    throw http_errors_1.default(400, `Incorrect field name format at: ${fieldname}`);
}
